...
<body>
  <div class="container text-center"> <!-- Wrap the content in a Bootstrap container -->
   <h1 style="color: black;"><b>WELCOME</b></h1>
    <center> <b><p style="color:Darkblue; font-size: 25px; "></h1></b><br><br>
              ...
              <input type="radio" id="status" name="status" value="Faculty">
               <label for="status_faculty"><b>Faculty</b></label><br><br> 
                ...
                <p>If done setting up your account,<br>
                 ...
                 <button type="button" onclick="window.location.href='dashboard'" style="width: 110px; font-size: 17px; height: 40px; background-color: maroon; color: #fff; border: none; border-radius: 3px;">DONE</button>
                  </form>    <!-- Form ends here -->
