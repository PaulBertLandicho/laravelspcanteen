        ...
        <span class="picture">
         <img class="profile" src="{{URL('images/profile.jpg')}}" style="width: 50px; height: 50px; border-radius: 50%; margin-right:5px;">
            ...
            <div class="icon-container">
              <div class="iconbar">
               <a href="dashboard" style="text-decoration: none;"><img src="https://cdn-icons-png.flaticon.com/512/5562/5562062.png" alt="Home"><div class="icon-text" style="color: black; margin-left:10px;">All</div></a>
