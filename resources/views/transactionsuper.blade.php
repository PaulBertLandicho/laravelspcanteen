@extends('layout.app')
 ...
 <center>
    <div class="container-shadow">
      ...
      <div class="icon-bar">
       ...
       <a class="active" href="superproductlist"><span class="far fa-plus-square"><class style="color: black; margin-left:26px;">Add Products</span>
         ...
         <div class="container">
         <h2 style="margin-bottom:180px;">
          <b>Transaction History</b>
          </h2>
        <div class="container " style="width: 1000px;  height:97px; background-color: white; border-radius: 17px;  margin-bottom: 20px;">
       <p style="font-size: 15px; margin-left:20px; color:gray;">Status <span style="font-size: 15px; font-weight: normal; margin-left:170px;">Amount <span style="font-size: 15px; font-weight: normal; margin-left:170px;">Date <span style="font-size: 15px; font-weight: normal; margin-left:170px;">Transaction Date</span>
        <h3 style="font-size: 15px; font-weight: bold; ">
         <i class="fa fa-circle" style="color: orange; margin-right: 10px;"></i>Processing <span style="font-size: 15px; font-weight: normal; margin-left:130px; font-weight: bold;">₱ 135.00</span>
  ...
  <div class="container " style="width: 1000px; margin-bottom: 4px; height:97px; background-color: white; border-radius: 17px;  margin-bottom: 20px;">
    <p style="font-size: 15px; margin-left:20px; color:gray;">Status <span style="font-size: 15px; font-weight: normal; margin-left:170px;">Amount <span style="font-size: 15px; font-weight: normal; margin-left:170px;">Date <span style="font-size: 15px; font-weight: normal; margin-left:170px;">Transaction Date</span>
          <h3 style="font-size: 15px; font-weight: bold; ">
            <i class="fa fa-circle" style="color: red; margin-right: 10px;"></i>Cancelled <span style="font-size: 15px; font-weight: normal; margin-left:130px; font-weight: bold;">₱ 105.00</span>
  ...
  <div class="container " style="width: 1000px; margin-bottom: 4px; height:97px; background-color: white; border-radius: 17px;  margin-bottom: 20px;">
    <p style="font-size: 15px; margin-left:20px; color:gray;">Status <span style="font-size: 15px; font-weight: normal; margin-left:170px;">Amount <span style="font-size: 15px; font-weight: normal; margin-left:170px;">Date <span style="font-size: 15px; font-weight: normal; margin-left:170px;">Transaction Date</span>
          <h3 style="font-size: 15px; font-weight: bold; ">
            <i class="fa fa-circle" style="color: green; margin-right: 10px;"></i>Successful <span style="font-size: 15px; font-weight: normal; margin-left:130px; font-weight: bold;">₱ 35.00</span>
            <span style="font-size: 15px; font-weight: normal; margin-left:130px; font-weight: bold;">3 February 2024</span>
